...
public interface IMemberRepository extends JpaRepository<Member, Long> {
     ...
     * @return {@link Optional} que contiene el miembro si existe, o vacío si no se
     *         encuentra.
     */
     ...
     *
     * @param tenantId ID del tenant para el cual se quiere contar los miembros por
     *                 grupo
     * @return Lista de objetos con el ID del grupo, nombre del grupo y cantidad de
     *         miembros
     */
    ...
    /**
     * Recupera todos los miembros de un tenant con información completa de subgrupo
     * y sección.
     * Realiza LEFT JOIN FETCH para evitar lazy loading y obtener toda la
    ...
    /**
     * Cuenta la cantidad de miembros por grupo a nivel global (sin filtrar por
     * tenant).
     * 
    ...
    /**
     * Cuenta la cantidad de miembros por grupo a nivel global y devuelve DTOs con
     * nombre del grupo.
     * 
     ...
     * 
     * @param memberId     ID del miembro cuyo subgrupo se usará para la
     *                     actualización.
    ...
    List<Member> findByRoleAndTenantId(String role, String tenantId);
}
