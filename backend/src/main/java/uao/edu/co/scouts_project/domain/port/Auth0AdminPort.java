 ...
 * (Crear usuario, asignar rol, listar usuarios/roles/organizaciones, verificación básica.)
 *
 * Implementaciones pertenecen a la capa de infraestructura como Adaptadores (ej: usando ManagementAPI).
 */
public interface Auth0AdminPort {
    ...
    // DTOs declarados en paquete domain.dto.auth0
}
