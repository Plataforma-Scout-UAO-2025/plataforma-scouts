    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/tenants/*").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/tenants/*").permitAll()

                            //Operaciones CRUD en grupos

                        .requestMatchers(HttpMethod.POST, "/api/v1/tenants/*/groups/**").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/v1/tenants/*/groups/**").permitAll()
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/tenants/*/groups/**").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/tenants/*/groups/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/storage/**").permitAll()
