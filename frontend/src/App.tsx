        ...
        <Routes>
          ...
          <Route path="/app" element={<AppLayout />}>
            ...
            */}
            ...
            {/* Rutas para guardian */}
            <Route path="guardians" element={<ProtectedRoute allowedRoles={["ACUDIENTE"]}><GuardianDashboard /></ProtectedRoute>} />
            <Route path="guardians/members" element={<ProtectedRoute allowedRoles={["ACUDIENTE"]}><GuardianLayout /></ProtectedRoute>} />
