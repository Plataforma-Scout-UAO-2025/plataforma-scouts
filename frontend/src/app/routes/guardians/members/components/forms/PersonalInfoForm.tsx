    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Select onValueChange={(value: string) => setValue('documentType', value as MemberFormData['documentType'])}>
            <SelectTrigger>
        ...
        <div>
          ...
          <Select onValueChange={(value: string) => setValue('gender', value as MemberFormData['gender'])}>
            <SelectTrigger>
              <SelectValue placeholder="Seleccionar" />
            </SelectTrigger>
            <SelectContent>
