...
export const memberSchema = z.object({
  ...
  guardian_id: z.number().int().min(1, "El ID del tutor debe ser un número positivo").optional(),
  relationship: z.string().optional(),
  role: z.enum(["admin_group", "admin_global", "scout"],
    { message: "Rol no válido" }).optional(),
  ...
  emergency_phone: z.array(z.string().min(1, "El teléfono de emergencia es requerido")).optional(),
});
...
export const updateMemberSchema = z.object({
  ...
  subgroup_id: z.number().int().min(1, "El ID del subgrupo es requerido").optional(),
  subgroup_name: z.string().min(1, "El nombre del subgrupo es requerido").optional(),
  section_id: z.number().int().min(1, "El ID de la sección es requerido").optional(),
  section_name: z.string().min(1, "El nombre de la sección es requerido").optional(),
